...
import { ITemperatureData } from '../temperature/models/temperature-data.model';
...
export class TemperatureService {
  ...
  getAllData(): Observable<ITemperatureData[]> {
    return this._httpClient.get<ITemperatureData[]>(`${this.baseUrl}`).pipe(catchError(this.handleError));
  }

  getDateTwoParam(startDate: Date, endDate: Date): Observable<ITemperatureData[]> {
    ...
    var endIsoDate = new Date(endDate.getTime() - (endDate.getTimezoneOffset() * 60000)).toISOString();
      return this._httpClient.get<ITemperatureData[]>('..............................?startDate='
