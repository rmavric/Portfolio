...
@Component({
  selector: 'app-consumed-voltage-diagram',
  templateUrl: './consumed-voltage-diagram.component.html',
  styleUrls: ['./consumed-voltage-diagram.component.scss']
})
export class ConsumedVoltageDiagramComponent implements OnChanges {
