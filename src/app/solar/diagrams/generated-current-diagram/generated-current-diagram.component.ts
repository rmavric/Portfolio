...
@Component({
  selector: 'app-generated-current-diagram',
  templateUrl: './generated-current-diagram.component.html',
  styleUrls: ['./generated-current-diagram.component.scss']
})
export class GeneratedCurrentDiagramComponent implements OnChanges {
