...
@Component({
  selector: 'app-generated-power-diagram',
  templateUrl: './generated-power-diagram.component.html',
  styleUrls: ['./generated-power-diagram.component.scss']
})
export class GeneratedPowerDiagramComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    for (var i = 0; i < powerData.length; i++) {
      ...
      // if index is equal to index of MIN power value then is necessarry to put marker in the dataPoints array
      if (i == indexOfMin) {
      ...
      // if index is equal to index of MAX power value then is necessarry to put marker in the dataPoints array
